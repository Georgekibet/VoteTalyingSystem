    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
       ...
       // public DbSet<User> Users { get; set; }
        ...
        protected override void OnModelCreating(System.Data.Entity.DbModelBuilder modelBuilder)
        {
            ...
            #region Identity
            modelBuilder.Entity<ApplicationUser>().ToTable("User_Users", "dbo").Property(p => p.Id).HasColumnName("UserId");
            modelBuilder.Entity<IdentityUser>().ToTable("User_Users", "dbo").Property(p => p.Id).HasColumnName("UserId");
            modelBuilder.Entity<IdentityRole>().ToTable("User_Roles", "dbo");
            modelBuilder.Entity<IdentityUserRole>().ToTable("User_UserRoles", "dbo");
            modelBuilder.Entity<IdentityUserClaim>().ToTable("User_UserClaims", "dbo");
            modelBuilder.Entity<IdentityUserLogin>().ToTable("User_UserLogins", "dbo");
            #endregion
            ...
            modelBuilder.Entity<ReferendumResult>().ToTable("Results_Referendum");
            modelBuilder.Entity<ReferendumResultLineItem>().ToTable("Results_ReferendumLineItems");

            #endregion Results
        }
    }

    public enum MainRole{ Admin, Clerk, Client }
}