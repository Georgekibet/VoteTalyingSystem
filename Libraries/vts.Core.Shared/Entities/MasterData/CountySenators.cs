...
{
    public class CountySenators : MasterEntity<CountySenatorsRef>
    {
        public CountySenators()
            : base(default(Guid))
        {
        ...
        public CountySenators(Guid id, DateTime dateCreated, DateTime dateLastUpdated, EntityStatus status)
        ...
        public override CountySenatorsRef GetMasterDataRef()
        {
            return new CountySenatorsRef()
            {
                Id = Id
            };
        }
    ...
    [ComplexType]
    public class CountySenatorsRef : MasterDataRef
    {
        public override MasterDataCollection MasterDataType
        {
            get { return MasterDataCollection.CountySenators; }
        }
        ...
        public static CountySenatorsRef CreateEmpty()
        {
            return MasterDataRef.CreateEmpty<CountySenatorsRef>();
        }
