...
namespace Mobile.Common.Core
{
    ...
    {
        public BasicTabHost TabHost { get; set; }
        ...
        protected virtual void NewIntent()
        {
        }
        ...
        public virtual bool IsPrinterSet()
        {
            return false;
        }
        ...
        protected virtual void FragmentAttached()
        {
        }
        ...
        public void ResetState(bool resetState)
        {
            if (resetState)
            {
                ...
                SearchWidget.Text = string.Empty;
