...
{
    public class ConnectivityMonitor<U> : IConnectivityMonitor
    {
        ...
        private void StartMonitoring()
        {
            lock (@lock)
            {
                ...
                app.RegisterReceiver(networkStateChangeReceiver, new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
                registered = true;
            }
        }
